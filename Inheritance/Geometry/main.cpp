...
void main()
{
	...
	Geometry::EquilateralTriangle equilateral_triangle(175, Geometry::Color::green, 500, 150, 2);
	equilateral_triangle.info();

	Geometry::IsoscelesTriangle isosceles_triangle(100, 175, Geometry::Color::red, 800, 150, 12);
